# 99-experiments/musl-tcc/patches/musl-1.2.6-tcc-no-plt.patch

This note is the evidence trail for `99-experiments/musl-tcc/patches/musl-1.2.6-tcc-no-plt.patch`.
