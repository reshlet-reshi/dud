...
dud_dir=.dud
tcc_dir=$dud_dir/musl-tcc
work_dir=$dud_dir/musl-tcc-build
tcc_stamp=03-musl-tcc/.stamp
tcc=$tcc_dir/tcc
smoke_cc=$dud_dir/smoke-cc
...
bootstrap_musl_cc=$PWD/.dud/x86_64-linux-musl-native/bin/x86_64-linux-musl-gcc
...
"$tcc" -static 03-musl-tcc/test/tcc1-smoke.c \
