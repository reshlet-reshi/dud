# proto/musl-tcc/patches/tcc-0.9.27-self-lib-path.patch

This note is the evidence trail for `proto/musl-tcc/patches/tcc-0.9.27-self-lib-path.patch`.
...
`proto/musl-tcc/runme.sh` builds the final compiler with:
