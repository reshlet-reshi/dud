# proto/musl-tcc/patches/tcc-0.9.27-tccelf.patch

This note is the evidence trail for `proto/musl-tcc/patches/tcc-0.9.27-tccelf.patch`.
...
TCC_TARBALL      proto/musl-tcc/tcc-0.9.27.tar.bz2
```
...
de23af78fca90ce32dff2dd45b3432b2334740bb9bb7b05bf60fdbfc396ceb9c  proto/musl-tcc/tcc-0.9.27.tar.bz2
5fc861bb9761f097fea129cde479c876a6e31acdffbc428a3038a0c1cc6294d4  proto/musl-tcc/patches/tcc-0.9.27-tccelf.patch
```
...
`/tmp/tccgot-plan.1pHU9u` from fresh `proto/musl-tcc/tcc-0.9.27.tar.bz2`
extracts. The host
